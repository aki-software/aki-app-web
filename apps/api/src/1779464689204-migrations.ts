...
export class Migrations1779464689204 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sessions" ADD CONSTRAINT "FK_3238ef96f18b355b671619111bc" FOREIGN KEY ("id") REFERENCES "session_metrics"("session_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sessions" DROP CONSTRAINT "FK_3238ef96f18b355b671619111bc"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "session_metrics" DROP CONSTRAINT "FK_82f41dc4d58d4f608f65b077308"`,
    );
    await queryRunner.query(
