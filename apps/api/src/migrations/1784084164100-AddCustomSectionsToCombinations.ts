...
export class AddCustomSectionsToCombinations1784084164100 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tres_areas_combinations" ADD "custom_sections" jsonb NOT NULL DEFAULT '[]'`,
    );
    await queryRunner.query(
      `ALTER TABLE "session_results" ALTER COLUMN "percentage" SET DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "session_results" ALTER COLUMN "percentage" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "tres_areas_combinations" DROP COLUMN "custom_sections"`,
    );
  }
}
