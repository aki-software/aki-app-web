...
const LoginPage = lazy(() =>
  import("../features/auth/views/LoginPage").then((m) => ({
    default: m.LoginPage,
  })),
);
const SetupPasswordPage = lazy(() =>
  import("../features/auth/views/SetupPasswordPage").then((m) => ({
    default: m.SetupPasswordPage,
  })),
);
const ForgotPasswordPage = lazy(() =>
  import("../features/auth/views/ForgotPasswordPage").then((m) => ({
    default: m.ForgotPasswordPage,
  })),
);
const ResetPasswordPage = lazy(() =>
  import("../features/auth/views/ResetPasswordPage").then((m) => ({
...
const DashboardOverview = lazy(() =>
  import("../features/dashboard/views/DashboardOverview").then((m) => ({
    default: m.DashboardOverview,
  })),
);
const DashboardResults = lazy(() =>
  import("../features/dashboard/views/DashboardResults").then((m) => ({
    default: m.DashboardResults,
  })),
);
const SessionDetailPage = lazy(() =>
  import("../features/dashboard/views/SessionDetailPage").then((m) => ({
    default: m.SessionDetailPage,
  })),
);
const DashboardVouchers = lazy(() =>
  import("../features/dashboard/views/DashboardVouchers").then((m) => ({
    default: m.DashboardVouchers,
  })),
);
const DashboardUsers = lazy(() =>
  import("../features/dashboard/views/DashboardUsers").then((m) => ({
    default: m.DashboardUsers,
  })),
);
const InstitutionDetailOverview = lazy(() =>
  import("../features/dashboard/views/InstitutionDetailOverview").then((m) => ({
    default: m.InstitutionDetailOverview,
  })),
);
const DashboardSettings = lazy(() =>
  import("../features/dashboard/views/DashboardSettings").then((m) => ({
    default: m.DashboardSettings,
  })),
);
const DashboardActivity = lazy(() =>
  import("../features/dashboard/views/DashboardActivity").then((m) => ({
    default: m.DashboardActivity,
  })),
);
const BillingDashboard = lazy(() =>
  import("../features/billing/pages/BillingDashboard").then((m) => ({
    default: m.BillingDashboard,
  })),
);
const AdminPricingPlansPage = lazy(() =>
  import("../features/admin/views/AdminPricingPlansPage").then((m) => ({
...
function RootRedirect() {
  ...
  return (
    <Navigate
      to={isAuthenticated ? APP_ROUTES.DASHBOARD.ROOT : APP_ROUTES.AUTH.LOGIN}
      replace
    />
  );
}
